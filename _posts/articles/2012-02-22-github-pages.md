...
description: Github本身就是不错的代码社区，他也提供了一些其他的服务，比如Github Pages，使用它可以很方便的建立自己的独立博客，并且免费。//byme:本篇文章转载自BeiYuu，这篇教程是我开始的地方，所以把它直接fork过来了，非常感谢原作者BeiYuu。看教程时，不必太纠结于那几张图片，时间飞逝，变化神速，文字思想才是最重要的。
category: articles
tags: [tutorial]
---
